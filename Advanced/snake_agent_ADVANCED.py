...
from snake_game_ADVANCED import SnakeGameAI, Direction, Point
...
def train():
    ...
    while True:
        ...
        reward, done, score = game.play_step(final_move, current_time)
        ...
        if done:
            ...
            if score > record:
                record = score
                agent.model.save(game.__repr__()+' Model.pth')
